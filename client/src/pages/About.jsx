  ...
  return (
    <div className="hero min-h-screen bg-base-200">
      <div className="hero-content flex-col lg:flex-row-reverse">
        <img
          src={about}
          className="max-w-full object-cover  w-full rounded-lg shadow-2xl"
        />
        <div>
          <h1 className="text-xl  lg:text-5xl text-indigo-600  font-bold">
            About Home Estate
          </h1>
          <p className="py-6  text-slate-700 ">
            <span className="font-bold text-indigo-600 "> Home Estate </span>is
            a leading real estate agency that specializes in helping clients
